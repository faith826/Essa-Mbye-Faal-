...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  const socialLinks = [
    {
      name: 'facebook',
      href: 'https://facebook.com/share/1F18pLGRau/',
      icon: (
    ...
    {
      name: 'instagram',
      href: 'https://www.instagram.com/appsobeyaaofficial?igsh=MWx3YnE3bjRocGxsYw==',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      name: 'youtube',
      href: 'https://www.youtube.com/@APPSOBEYAAUSCHAPTER',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              <div className="flex items-center gap-3 text-slate-400 text-[11px] font-medium">
                ...
                <span>essambyefaalofficial@gmail.com</span>
              </div>
              <div className="flex items-center gap-3 text-slate-400 text-[11px] font-medium">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1 mt-2">
            <p className="text-[9px] text-slate-600 font-bold tracking-widest uppercase text-center">
