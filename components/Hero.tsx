        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button 
              ...
              className="h-12 px-10 rounded bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold tracking-widest transition-all shadow-[0_0_20px_-5px_rgba(37,99,235,0.4)] flex items-center justify-center gap-2 uppercase active:scale-95"
            >
              Join the Movement
            ...
            <button 
              ...
              className="h-12 px-10 rounded border border-white/10 bg-white/5 hover:bg-white/10 text-white text-xs font-bold tracking-widest transition-colors backdrop-blur-sm flex items-center justify-center gap-2 uppercase active:scale-95"
            >
